...
public class MyImageRequest extends Request<Bitmap> {
    ...
    public boolean forced_cache = false;
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (mMaxWidth == 0 && mMaxHeight == 0) {
            ...
            // TO.DO(ficus): Do we need this or is it okay since API 8 doesn't support it?
        ...
        if (bitmap == null) {
            ...
            if(forced_cache){
                return Response.success(bitmap, MyHttpHeaderParser.parseIgnoreCacheHeaders(response));
            }else{
                return Response.success(bitmap, MyHttpHeaderParser.parseCacheHeaders(response));
            }
