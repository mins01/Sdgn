...
//                Intent intent = new Intent(MainActivityOld.this,DetailActivity.class);
...
//        });
    ...
    private void firstAction() {
        (new AsyncTask<MainActivityOld, Void, MainActivityOld>() {
            @Override
            protected MainActivityOld doInBackground(MainActivityOld... params) {
                return params[0];
            }

            @Override
            protected void onPostExecute(MainActivityOld result) {
